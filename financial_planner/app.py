...
async def index():
    return """<!DOCTYPE html>
<html lang="en" style="height: auto !important; min-height: auto !important; overflow: auto !important; display: block !important;">
<head>
    <meta charset="UTF-8">
...
<body style="height:auto !important; min-height:auto !important; overflow:auto !important; display:block !important; margin:0; padding:0;">
    ...
    <footer>
        <div class="container">
            <p class="mb-0">
                Created by
                <a href="https://github.com/arunabh98" target="_blank" rel="noopener noreferrer" style="color: var(--primary-color); text-decoration: none; font-weight: 500;">Arunabh Ghosh</a>
            </p>
            <p class="mt-2 text-muted" style="font-size: 0.85rem;">Disclaimer: This tool is provided for research purposes only and does not constitute professional financial advice. Always consult a qualified financial advisor before making any financial decisions.</p>
        </div>
    </footer>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/es6-promise/dist/es6-promise.auto.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/whatwg-fetch@3.6.2/dist/fetch.umd.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/web-streams-polyfill/dist/polyfill.min.js"></script>
